        ...
        if let Some(components) = openapi.components.as_mut() {
            ...
            let pagination_schema = schema::ObjectBuilder::new()
                ...
                .property("limit", schema::ObjectBuilder::new()
                    ...
                    .default(Some(::entity_derive::serde_json::json!(100)))
                    .minimum(Some(1.0))
                    .maximum(Some(1000.0))
                    .build())
                .property("offset", schema::ObjectBuilder::new()
                    ...
                    .default(Some(::entity_derive::serde_json::json!(0)))
                    .minimum(Some(0.0))
                    .build())
                .build();
