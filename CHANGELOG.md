...
- Entity derive macro for domain code generation by @RAprogramm
...
- Add comprehensive documentation, refactor utils by @RAprogramm
- Prepare for crates.io publication by @RAprogramm
- Add code coverage section with graphs by @RAprogramm
- Add table of contents and back-to-top links by @RAprogramm

### Miscellaneous Tasks

- Add comprehensive CI workflow by @RAprogramm
